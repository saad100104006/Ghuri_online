...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH="/data/data/com.online.ghuri/databases/";
	private static String DB_NAME = "event.sqlite";
	...
	public void createDatabase() throws IOException {
		...
		if (dbExist) {
			...
			myDataBase.execSQL("DROP TABLE IF EXISTS " + "sms_tbl");
